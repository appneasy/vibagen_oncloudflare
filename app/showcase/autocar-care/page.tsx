...
export const metadata: Metadata = {
  ...
  keywords: ['autocar care', 'ระบบคาร์แคร์', 'ระบบอู่ซ่อมรถ', 'โปรแกรมอู่ซ่อมรถ', 'โปรแกรมคาร์แคร์', 'line liff', 'perpetual license', 'จองคิวออนไลน์', 'dvi inspection', 'car care management', 'ระบบจัดการร้านล้างรถ'],
  openGraph: {
