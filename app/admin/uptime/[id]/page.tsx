            ...
            <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: 13 }}>
              <thead>
                <tr style={{ background: '#f8f9fc' }}>
                  <th style={{ padding: '10px 16px', textAlign: 'left', color: '#0d2749', fontWeight: 600, fontSize: 12 }}></th>
                  <th style={{ padding: '10px 16px', textAlign: 'left', color: '#0d2749', fontWeight: 600, fontSize: 12 }}>Status Code</th>
                  <th style={{ padding: '10px 16px', textAlign: 'left', color: '#0d2749', fontWeight: 600, fontSize: 12 }}>Response Time</th>
                  <th style={{ padding: '10px 16px', textAlign: 'left', color: '#0d2749', fontWeight: 600, fontSize: 12 }}>Region</th>
                  <th style={{ padding: '10px 16px', textAlign: 'left', color: '#0d2749', fontWeight: 600, fontSize: 12 }}>Time</th>
                </tr>
              </thead>
              <tbody>
        ...
        {recentIncidents.length === 0 ? (
          ...
          <div style={{ overflowX: 'auto' }}>
            <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: 13 }}>
              <thead>
                <tr style={{ background: '#f8f9fc' }}>
                  <th style={{ padding: '10px 16px', textAlign: 'left', color: '#0d2749', fontWeight: 600, fontSize: 12 }}>Severity</th>
                  <th style={{ padding: '10px 16px', textAlign: 'left', color: '#0d2749', fontWeight: 600, fontSize: 12 }}>Started</th>
                  <th style={{ padding: '10px 16px', textAlign: 'left', color: '#0d2749', fontWeight: 600, fontSize: 12 }}>Resolved</th>
                  <th style={{ padding: '10px 16px', textAlign: 'left', color: '#0d2749', fontWeight: 600, fontSize: 12 }}>Duration</th>
                  <th style={{ padding: '10px 16px', textAlign: 'left', color: '#0d2749', fontWeight: 600, fontSize: 12 }}>Cause</th>
                </tr>
              </thead>
              <tbody>
